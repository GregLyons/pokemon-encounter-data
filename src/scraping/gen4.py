...
def main():
    ...
    with open(fname_dppt, 'w', newline='', encoding='utf-8') as csvFile_rse, open(fname_hgss, 'w', newline='', encoding='utf-8') as csvFile_frlg:
        ...
        makeEncounterCSV(
            findTable, {'DPPt': writer_dppt, 'HGSS': writer_hgss}, 'IV')
